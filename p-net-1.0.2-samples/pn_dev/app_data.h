...
/**
 * Initialize application data and debug serial port
 ...
 * Establishes persistent connection to 127.0.0.1:31000.
 * The connection is used by app_data_set_output_data() to forward
 * PLCFrame data and receive robot status responses.
 *
